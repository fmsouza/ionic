...
export class SettingsPage {
    ...
    public constructor(private preferences: PreferencesManager, private analytics: Analytics, private appVersion: AppVersion) {
        this.analytics.trackView('SettingsPage');
    }
    ...
    public onHideTrajectoryChange(): void {
        this.analytics.trackEvent('trajectory switch', 'toggle', `${this.hideTrajectory}`);
    ...
    public onHideOldBusesChange(): void {
        this.analytics.trackEvent('old buses switch', 'toggle', `${this.hideOldBuses}`);
